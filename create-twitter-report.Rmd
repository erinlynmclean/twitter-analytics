...
ADC_allothers<-subset(ADC, created_at < as.Date("2020-03-01"))
#Remove retweets
...
set.seed(1234)
wordcloud(ADC_tweets_organic$hashtags, min.freq=4, scale=c(6, .75), random.order=FALSE, rot.per=0.45, 
          colors=ADC_colors)
```
...
### Understanding sentiment of tweets
